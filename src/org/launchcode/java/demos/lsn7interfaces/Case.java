...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Nonpareils", 0.5, new ArrayList<>(Arrays.asList("")));
        Topping topping2 = new Topping("Crushed Walnuts", 0.5, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping3 = new Topping("Warm Fudge", 0.5, new ArrayList<>(Arrays.asList("dairy")));
